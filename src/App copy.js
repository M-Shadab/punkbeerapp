...
export default class App extends Component {
  ...
  renderHomePage = props => (
    <Home
      {...props}
      beers={this.state.searchQuery ? this.state.searchBeers : this.state.beers}
  ...
  render = () => {
    return (
      <main>
        <NavBar />
        <SearchBar value={this.state.query} onChange={this.handleChangeSearch} onClick={this.handleClickSearchBtn} />
        <Switch>
